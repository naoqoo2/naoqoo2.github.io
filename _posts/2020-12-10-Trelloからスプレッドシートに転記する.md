...
（以前 [スプレッドシートからTrelloにカード追加する](https://naoqoo2.github.io/20180402-スプレッドシートからTrelloにカード追加する（任意の行だけ選択可能）.md) を書いたのですが、今回はその逆です）  
...
（参考：[スプレッドシートからTrelloにカード追加する](https://naoqoo2.github.io/20180402-スプレッドシートからTrelloにカード追加する（任意の行だけ選択可能）.md) ）  
